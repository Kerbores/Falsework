...
;(function ($, window, document, undefined) {
    ...
    var pluginName = 'bootstrapDualListbox',
        defaults = {
            ...
            filterPlaceHolder: '键入关键词筛选',
            moveSelectedLabel: '移动选中项',
            moveAllLabel: '移动全部',
            removeSelectedLabel: '删除选中项',
            removeAllLabel: '删除全部',
            ...
            infoText: '数据总数{0}',                                                        // text when all options are visible / false for no info text
            infoTextFiltered: '<span class="label label-warning">筛选</span> {0} 从 {1}', // when not all of the options are visible due to the filter
