...
public class SINOPermissionAnnotationHandler extends PermissionAnnotationHandler {
	 ...
	 */
	public SINOPermissionAnnotationHandler() {
		setAnnotationClass(SINORequiresPermissions.class);
	}
	 ...
	 *
	 * @param a
	 *            the NutzRequiresPermissions annotation being inspected to check
	 *            for one or more permissions
