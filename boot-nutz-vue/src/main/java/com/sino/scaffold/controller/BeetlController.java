...
public class BeetlController extends BaseController {
	...
	@GetMapping("/")
	@RequestMapping("/")
	public String home(Model model, @SessionAttribute(name = BootNutzVueApplication.USER_KEY, required = false) User user) {
		if (user != null) {
			return "redirect:/dashboard";
		}
		String cookie = _getCookie(BootNutzVueApplication.USER_COOKIE_KEY);
